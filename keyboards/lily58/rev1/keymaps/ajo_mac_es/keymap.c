...
[_LOWER] = LAYOUT(
  ...
  _______  , _______  , _______, _______, _______, _______,                    ES_LBRC, ES_RBRC, _______, _______, _______,  KC_F12,
  _______  , KC_GRV   , _______, _______, _______, _______,                    ES_LCBR, ES_RCBR, _______, _______, _______, ES_APOS,
  _______  , S(KC_GRV), _______, _______, _______, _______, _______, _______,  KC_PLUS, KC_UNDS, _______, KC_LCBR, KC_RCBR, ES_PIPE,
